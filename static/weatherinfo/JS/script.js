...
function getWeather(weather){
	if(weather == "Haze"){
				if(time<18 && time>6)
					return "{{ url_for('static', filename='weatherinfo/Resources/cloudy-day-1.svg') }}"
				else
					return "{{ url_for('static', filename='weatherinfo/Resources/cloudy-night-1.svg') }}"
			}
			else if(weather == "Clouds"){
				return "{{ url_for('static', filename='weatherinfo/Resources/cloudy.svg') }}"	
			}
			else if(weather == "Rain"){
				return "{{ url_for('static', filename='weatherinfo/Resources/rainy-6.svg') }}"	
			}
			else if(weather == "Mist"){
				return "{{ url_for('static', filename='weatherinfo/Resources/snowy-4.svg') }}"	
			}
			else if(weather == "Clear"){
				if(time<18 && time>6)
					return "{{ url_for('static', filename='weatherinfo/Resources/day.svg') }}"
				else
					return "{{ url_for('static', filename='weatherinfo/Resources/night.svg') }}"
			}
			else if(weather == "Smoke"){
				return "{{ url_for('static', filename='weatherinfo/Resources/snowy-6.svg') }}"	
			}
			else if(weather == "Drizzle"){
				return "{{ url_for('static', filename='weatherinfo/Resources/rainy-7.svg') }}"	
			}
			else if(weather == "Thunderstorm"){
				return "{{ url_for('static', filename='weatherinfo/Resources/thunder.svg') }}"		
			}
			return;
}
